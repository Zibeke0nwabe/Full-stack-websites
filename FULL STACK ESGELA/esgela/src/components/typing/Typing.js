...
const TypingTest = () => {
    ...
    return (
        <div className="bg-white p-6 rounded border border-gray-300 flex flex-col h-full">
            ...
            <div className="flex justify-between mt-4">
                <Link to="/typing" className="text-blue-600 hover:underline">Reset</Link>
