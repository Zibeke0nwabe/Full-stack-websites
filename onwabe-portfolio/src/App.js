...
const projects = [
  {
    ...
    website: '',
    github: 'https://github.com/onwabe/esgela',
  ...
  },
  {
    ...
    "website": "https://www.esgla.onrender.com/",
...
`,  
...

  {
    ...
    website: 'https://github.com/onwabe/football-fixture-generator',
  ...
  },
  {
    ...
    detailedDescription: 'Image Protector is a web application that allows users to upload images, store them securely in local storage, and download them. The application is built using HTML, CSS, and JavaScript, featuring a user-friendly interface and local storage management.',
  ...
  // More projects will be added here when I am done with them
];
